...
export default function HowToOrderPage() {
  ...
  const message = encodeURIComponent("Salam, saya telah membuat pembayaran dan ingin menghantar bukti bayaran.");
  ...
  return (
    <div className="container mx-auto px-4 py-16">
              ...
              <Card key={index} className="shadow-md">
                ...
                <CardContent>
                  ...
                  {category.title === 'E-Wallet' && (
                     <div className="mt-4 p-4 bg-muted rounded-lg">
                        <p className="font-semibold">Imbas QRIS di bawah:</p>
                        <div className="flex justify-center my-4">
                          <Image src={qrSrc} alt="TNG QR Code" width={250} height={250} className="rounded-lg" unoptimized/>
                        </div>
      ...
      <div className="text-center mt-16 bg-card p-8 rounded-lg shadow-xl">
        <h2 className="text-2xl font-headline font-bold mb-4">Sudah Membuat Pembayaran?</h2>
        <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
          Sila hantar bukti pembayaran anda melalui WhatsApp untuk kami proses pengaktifan akaun anda.
        </p>
